...
class TestErrorScenarios:
    ...
    def test_resource_exhaustion_recovery(self, test_client):
        ...
        assert recovery_response.status_code == 201 or recovery_response.status_code == 400
...
class TestErrorRecovery:
    ...
    def test_consistency_after_errors(self, test_client):
        ...
        for i in range(3):
            get_response = test_client.get(f"/get_feature_metadata/error:consistency{i}:v1?user_role=developer")
