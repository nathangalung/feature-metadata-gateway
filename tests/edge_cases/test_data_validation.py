...
#                 assert response.status_code in [400, 422], f"Expected failure for {test_case['field']}"
#             else:
#                 assert response.status_code == 201, f"Expected success for {test_case['field']}"
...
#                 "feature_name": f"edge:invalid_type:v{i}",
...
#             response = test_client.post("/create_feature_metadata", json={
#                 "feature_name": f"edge:invalid_data_type:v{i}",
#                 "feature_type": "batch",
...
#             "cat:name:1",  # Invalid version format
...
#                 "user_role": "developer"
#             })
#             assert response.status_code in [400, 422], f"Should reject invalid name: {invalid_name}"
...
#             else:
#                 assert response.status_code in [400, 422], f"Query should be rejected: {query}"
...
#             response = test_client.post("/create_feature_metadata", json=payload)
#             assert response.status_code in [400, 422], f"Should reject incomplete payload {i}"
...
#             response = test_client.post("/create_feature_metadata", json={
#                 "feature_name": f"edge:mismatch:v{i}",
#                 "feature_type": "batch",
...
#                 "feature_name": f"concurrent:validation:v{index}",
#                 "feature_type": "batch",
#                 "feature_data_type": "string",
