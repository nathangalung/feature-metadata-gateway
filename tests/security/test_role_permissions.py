...
class TestRolePermissions:
    ...
    def test_developer_permissions(self):
        ...
        response = self.client.post("/create_feature_metadata", json={
        ...
        response = self.client.post("/update_feature_metadata", json={
            "feature_name": "permissions:dev:v1",
        ...
        response = self.client.post("/ready_test_feature_metadata", json={
            "feature_name": "permissions:dev:v1",
        ...
        response = self.client.post("/test_feature_metadata", json={
            "feature_name": "permissions:dev:v1",
        ...
        response = self.client.post("/approve_feature_metadata", json={
            "feature_name": "permissions:dev:v1",
    ...
    def test_approver_permissions(self):
        ...
        # Reject
        response = self.client.post("/reject_feature_metadata", json={
            "feature_name": "permissions:reject:v1",
