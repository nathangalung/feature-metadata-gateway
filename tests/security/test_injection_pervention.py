...
class TestInjectionPrevention:
    ...
    def test_nosql_injection_prevention(self):
        ...
        nosql_payloads = [
            {"features": ["test:feature:v1"], "entities": {"user_id": ["user_1", "user_2', $where: null, name: '"]}},
            {"features": ["test:feature:v1"], "entities": {"user_id": ["user_1", "{$gt: ''}"]}},
            {"features": ["test:feature:v1"], "entities": {"user_id": ["user_1", "'], $or: [{}, {}, {}], field: ["]}},
            {"features": ["test:feature:v1"], "entities": {"user_id": ["user_1", "{$where: function() { return true }}"]}},
            {"features": ["test:feature:v1"], "entities": {"user_id": ["user_1", "{\"$gt\": \"\"}"]}}
        ]
