...
VALID_DATA_TYPES = ["string", "float", "integer", "boolean", "double", "bigint", "int", "decimal"]
VALID_USER_ROLES = ["developer", "external_testing_system", "approver"]
VALID_STATUSES = ["DRAFT", "READY_FOR_TESTING", "TEST_SUCCEEDED", "TEST_FAILED", "DEPLOYED", "DELETED"]
